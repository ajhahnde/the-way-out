...
class Shiggy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.facing = 'down'
        self.load_assets()
...
class MrGreen(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.facing = 'down'
        self.load_assets()
